...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.GarmentPackingList
{
    public class GarmentPackingListDataUtil : BaseDataUtil<GarmentPackingListRepository, GarmentPackingListModel>
    {
        ...
        public override GarmentPackingListModel GetModel()
        {
            ...
            var model = new GarmentPackingListModel("", "", "", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "", "", "", DateTimeOffset.Now, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", "", "", items, 1, 1, 1, 1, measurements, "", "", "", "", "", "", "", false, false, 1, "", GarmentPackingListStatusEnum.CREATED, "", false, "", false, false, false,"","",0);
        ...
        public GarmentPackingListModel CopyModel(GarmentPackingListModel om)
        {
            ...
            foreach (var i in om.Items)
            {
                ...
                foreach (var d in i.Details)
                {
                    ...
                    {
                        sizes.Add(new GarmentPackingListDetailSizeModel(s.SizeId, s.Size, s.SizeIdx, s.Quantity,s.Remark) { Id = s.Id });
                    }
            ...
            var model = new GarmentPackingListModel(om.InvoiceNo, om.PackingListType, om.InvoiceType, om.SectionId, om.SectionCode, om.Date, om.PaymentTerm, om.LCNo, om.LCDate, om.IssuedBy, om.BuyerAgentId, om.BuyerAgentCode, om.BuyerAgentName, om.Destination, om.FinalDestination, om.ShipmentMode, om.TruckingDate, om.TruckingEstimationDate, om.ExportEstimationDate, om.Omzet, om.Accounting, om.FabricCountryOrigin, om.FabricComposition, om.RemarkMd, items, om.GrossWeight, om.NettWeight, om.NetNetWeight, om.TotalCartons, measurements, om.SayUnit, om.ShippingMark, om.SideMark, om.Remark, om.ShippingMarkImagePath, om.SideMarkImagePath, om.RemarkImagePath, om.IsUsed, om.IsPosted, om.ShippingStaffId, om.ShippingStaffName, om.Status, om.Description, om.IsCostStructured, om.OtherCommodity, om.IsShipping, om.IsSampleDelivered, om.IsSampleExpenditureGood,om.SampleRemarkMd, om.UserAuthorizedName, om.TotalQuantity) { Id = om.Id };
